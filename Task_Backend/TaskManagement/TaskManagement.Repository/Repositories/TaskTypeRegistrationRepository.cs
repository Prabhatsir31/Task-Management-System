...
namespace TaskManagement.Repository.Repositories
{
    public class TaskTypeRegistrationRepository : ITaskTypeRegistration
    {
        ...
        public TaskTypeRegistrationRepository(ITaskContextFactory contextFactory, IMapper mapper)
        {
        ...
        public async Task<ResultModel> RegisterTaskTypeAsync(TaskTypeMasterRequest taskTypeRequest)
        {
            ...
            try
            {
                ...
                {
                    return ResultModelFactory.CreateFailure(ResultCode.DuplicateRecord, TaskMessages.taskType_Exist);
                }
            ...
            catch (Exception ex)
            {
                ...
                return ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, TaskMessages.Error_while_addupdate_taskType, ex);
            }
        }
