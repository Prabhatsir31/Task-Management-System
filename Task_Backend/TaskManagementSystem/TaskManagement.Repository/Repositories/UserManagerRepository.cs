...
namespace TaskManagement.Repository.Repositories
{
    public class UserManagerRepository : IUserManager
    {
        ...
        public UserManagerRepository(ITaskContextFactory contextFactory,
            IMapper mapper,
        ...
        public async Task<UserTokenDto> AuthenticateAsync(AuthenticateRequest model, string ipAddress)
        {
            try
            {
                ...
                if (userAccount == null || !BC.Verify(model.Password, userAccount.PasswordHash))
                    throw new AppException(TaskMessages.User_name_or_password_is_incorrect);
        ...
        public async Task<ResultModel> RegisterUserAsync(RegisterUserRequest registerUser)
        {
            try
            {
                ...
                if (userExists==true)
                {
                    return ResultModelFactory.CreateFailure(ResultCode.DuplicateRecord, TaskMessages.UserNameExist);
                }
                if (userPhoneExists == true)
                {
                    return ResultModelFactory.CreateFailure(ResultCode.DuplicateRecord, TaskMessages.UserPhoneExist);
                }
                ...
                if (isFirstAccount)
                {
                    ...
                    if (role == null)
                        return ResultModelFactory.CreateFailure(ResultCode.RecordNotFound, TaskMessages.No_super_admin_role_exists_to_create_first_user);
                    else
                ...
                await kUrgeTruckContext.SaveChangesAsync();
                return ResultModelFactory.CreateSucess(TaskMessages.User_registered_succesfully);
            }
            catch (Exception ex)
            {
                Logger.Error(TaskMessages.RegisterUserAsync_error + ex.Message);
        ...
        public async Task<ForgotPasswordResponse> ForgotPasswordAsync(ForgotPasswordRequest model, string origin)
        {
            ...
            if (userAccount == null)
                return new ForgotPasswordResponse { ErrorMessage = TaskMessages.User_Name_is_invalid };
        ...
        public async Task<ResultModel> ResetPasswordAsync(ResetPasswordRequest model)
        {
            try
            {
                ...
                if (userAccount == null)
                    return ResultModelFactory.CreateFailure(ResultCode.RecordNotFound, TaskMessages.no_record_found);
            ...
            {
                Logger.Error(TaskMessages.ResetPasswordAsync_error + ex.Message);
                return ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, ex.Message);
            }
        }
        ...
        {
            string _appSettings_Secret = TaskContextFactory.TokenSecrete;
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTimeFormatter.GetISDTime(DateTime.Now).AddMinutes(TaskContextFactory.TokenTTL),
        ...
        private RefreshToken GenerateRefreshToken(string ipAddress)
        {
            return new RefreshToken
            {
                ...
                Expires = DateTimeFormatter.GetISDTime(DateTime.Now).AddMinutes(TaskContextFactory.RefreshTokenTTL),
        ...
        public async Task<ResultModel> ChangePasswordAsync(ChangePasswordRequest changePasswordRequest, string token)
        {
            ...
            if (userAccount == null && !BC.Verify(changePasswordRequest.OldPassword, userAccount.PasswordHash))
                return ResultModelFactory.CreateFailure(ResultCode.RecordNotFound, TaskMessages.Invalid_user_name_or_password);
            ...
            if (BC.Verify(changePasswordRequest.OldPassword, userAccount.PasswordHash))
            {
                ...
                kUrgeTruckContext.UserManager.Update(userAccount);
                await kUrgeTruckContext.SaveChangesAsync();
                return ResultModelFactory.UpdateSucess(TaskMessages.Your_password_has_been_changed_successfully);
            }
            return ResultModelFactory.CreateFailure(ResultCode.Invalid, TaskMessages.Invalid_user_name_or_password);
        }
        ...
        public async Task<ResultModel> UpdateUserDeatilAsync(updateUserRequest model)
        {
            try
            {
                ...
                await kUrgeTruckContext.SaveChangesAsync();
                return ResultModelFactory.CreateSucess(TaskMessages.User_information_udpated_successfully);
            }
            catch (Exception ex)
            {
                Logger.Error(TaskMessages.UpdateUserDeatilAsync_error + ex.Message);
                return ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, TaskMessages.Error_while_addupdate_User_details, ex);
            }
        }
        ...
        public async Task<ResultModel> UploadUserImage(IFormFile file, int id)
        {
            try
            {
                ...
                {
                    return ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, TaskMessages.Error_While_UploadImage);
                }

                return ResultModelFactory.CreateSucess(TaskMessages.UpdatedProfileImage);
            }
            catch (Exception ex)
            {
                return ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, TaskMessages.Error_While_UploadImage, ex);
            }
        }
        ...
        private async Task UpdateUserProfileDetail(string path, int id)
        {
            ...
            {
                ResultModelFactory.CreateFailure(ResultCode.ExceptionThrown, TaskMessages.Error_While_UploadImage, ex);
            }
        }
