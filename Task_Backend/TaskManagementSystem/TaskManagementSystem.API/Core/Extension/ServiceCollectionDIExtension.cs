...
using Quartz.Impl;
using Quartz.Spi;
using TaskManagementSystem.Business.BusinessLogic;
...
using TaskManagementSystem.ServiceIntegration;

namespace TaskManagementSystem.API.Core.Extension
{
    public static class ServiceCollectionDIExtension
    {
        ...
        {
            services.AddSingleton<ITaskContextFactory, TaskContextFactory>();
