...
namespace TaskManagement.Domain.Common
{
    public static class TaskMessages
    {
        ...
        // Attendance
        public const string Attendance_Record_Not_Found = "Record not found between selected date range.";
        public const string Attendance_Success = "Attendance fetched successfully.";
    }
}
